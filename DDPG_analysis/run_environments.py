...
def main():
    ...
    if current_dir != "DDPG-analysis":
        print(f"Warning: Current directory is '{current_dir}', expected 'DDPG-analysis'")
        print("Changing to the DDPG-analysis directory...")
        os.chdir("DDPG-analysis")
